...
class Filter(commands.Cog):
    ...
    async def do_filter_notify(self, message: discord.Message, word):
        ...
        message_to_user = f"Your message contained a word you aren't allowed to say in {member.guild.name}. This could be either hate speech or something else disallowed. Please refrain from saying it!"
